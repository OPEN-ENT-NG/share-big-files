...
public class ShareBigFileStorage extends MongoDBApplicationStorage {
	...
	public ShareBigFileStorage() {
		super(ShareBigFiles.SHARE_BIG_FILE_COLLECTION, ShareBigFiles.class.getSimpleName(), new JsonObject()
				.putString("file", "fileId")
				.putString("name", "fileMetadata.filename")
				.putString("size", "fileMetadata.size")
				.putString("contentType", "fileMetadata.content-type")
				.putString("owner", "owner.userId")
				.putString("title", "fileNameLabel")
		);
	}
